      ...
      html: `
        ...
        <html>
          ...
          <body style="font-family: -apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, 'Helvetica Neue', Arial, sans-serif; line-height: 1.6; color: #333; max-width: 600px; margin: 0 auto; padding: 20px;">
            ...
            <div style="background: linear-gradient(135deg, #414b9e 0%, #9792cb 100%); padding: 30px; border-radius: 10px 10px 0 0; text-align: center;">
            ...
            <div style="background: #ffffff; padding: 30px; border: 1px solid #e5e7eb; border-top: none; border-radius: 0 0 10px 10px;">
              ...
              <div style="background: #fef3c7; border-left: 4px solid #f3c8dd; padding: 15px; margin: 20px 0; border-radius: 4px;">
                <p style="margin: 0; font-size: 14px; color: #3a345b;">
              ...
              <table style="width: 100%; margin: 20px 0;">
                ...
                <tr>
                  <td style="padding: 10px;">
                    ...
                    <div style="font-size: 32px; color: #414b9e; font-weight: bold;">
              ...
              <div style="text-align: center; margin: 30px 0;">
                <a href="${product.url}" 
                   style="display: inline-block; background: #414b9e; color: white; padding: 14px 30px; text-decoration: none; border-radius: 6px; font-weight: 600; font-size: 16px;">
                  View Product →
                </a>
              </div>
              ...
              <div style="border-top: 1px solid #e5e7eb; padding-top: 20px; margin-top: 20px; text-align: center; color: #6b7280; font-size: 12px;">
                ...
                <p style="margin-top: 10px;">
                  ...
                  }" style="color: #414b9e; text-decoration: none;">
